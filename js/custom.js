...
$(document).ready(function(){
   ...
   function validate( elem, pattern ){
      ...
      if( elem.val().match(pattern) == null) {
   ...
   $('body').on('submit', '.modal-body .form', function(e){
      ...
      validate(inputName, /[a-z]{2,}/i)
      validate(inputEmail, /[0-9a-z]+@[0-9a-z]+\.[0-9a-z]+/)
   ...
   $('body').on('blur', '#nome', function(){
      validate($(this), /[a-z]{2,}/i)
   })

   $('body').on('blur', '#email', function(){
      validate($(this), /[0-9a-z]+@[0-9a-z]+\.[0-9a-z]+/)
   })
